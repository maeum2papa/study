...
import jpabook.jpashop.repository.order.query.OrderItemQeuryDto;
...
public class OrderApiController {
    ...
    public List<OrderDto> ordersV3_1_1(
            @RequestParam(value = "offset",defaultValue = "0") int offset,
            @RequestParam(value = "limit",defaultValue = "100") int limit,
            @RequestParam(value = "memberName",defaultValue = "") String  memberName,
            @RequestParam(value = "orderStatus",defaultValue = "ORDER") String orderStatus
            ) {
        OrderSearch orderSearch = new OrderSearch();
        orderSearch.setMemberName(memberName);
        orderSearch.setOrderStatus(OrderStatus.valueOf(orderStatus));

        if(memberName.equals("")) {
            log.info("memberName가 없습니다.");
        }else{
    ...
    public List<OrderQueryDto> ordersV6() {
        ...
        return flats.stream()
                .collect(groupingBy(o -> new OrderQueryDto(o.getOrderId(), o.getName(), o.getOrderDate(), o.getOrderStatus(), o.getAddress()),
                        mapping(o -> new OrderItemQeuryDto(o.getOrderId(), o.getItemName(), o.getOrderPrice(), o.getCount()), toList())
                )).entrySet().stream()
